...
;              PendSV_Handler to run whenever there are no more interrupts active
...
;                         PERFORM A CONTEXT SWITCH (From task level) - OSCtxSw()
;
; Note(s) : 1) PendSV_Handler is used to cause a context switch.  This is a recommended
...
;
;           2) On entry into PendSV_Handler handler:
...
;
;           3) Since PendSV_Handler is set to lowest priority in the system (by OSCtxSw() above),

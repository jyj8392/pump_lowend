...
//					ShowStr(1, 0, "设定流量", 0);
					...
					sprintf(FlowParaAdjStr, "%03d.%01d", sysctl->setFlow/100, (sysctl->setFlow/10)%10);
					SetFlowParaAdjPos[0] = FlowParaAdjStr[0] - 0x30;
					SetFlowParaAdjPos[1] = FlowParaAdjStr[1] - 0x30;
					SetFlowParaAdjPos[2] = FlowParaAdjStr[2] - 0x30;
...
//				sysctl->nowPress = GetFLOWPLC();
			...
			if ((keyVal = OSMboxAccept(KeyMbox)) != NULL) {
				...
				case KEYNUM0:
					...
					FlowStr[2] = SetFlowPos[2] + 0x30;
					FlowStr[3] = '.';
					FlowStr[4] = SetFlowPos[3] + 0x30;
					ShowStr(2, 4, FlowStr, 2);
					break;
				case KEYSTART:
					if (MAXFLOW * 100 >= SetFlowPos[0] * 10000 + SetFlowPos[1] * 1000 + SetFlowPos[2] * 100 + SetFlowPos[3] * 10) {
			...
			if ((keyVal = OSMboxAccept(KeyMbox)) != NULL) {
				...
				case KEYNUM0:
					...
					FlowParaAdjStr[2] = SetFlowParaAdjPos[2] + 0x30;
					FlowParaAdjStr[3] = '.';
